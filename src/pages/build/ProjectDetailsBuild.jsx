...
const ProjectDetailsBuild = () => {
    ...
    const handleOpenContribute = () => {
        setOpenInceraseContribution(true)
    }
    const handleCloseContribute = () => {
        setOpenInceraseContribution(false)
    }
        ...
        <>
            ...
            <div className="w-full max-w-6xl mx-auto">
                ...
                <div className="relative">
                    ...
                    <div onClick={handleOpenContribute} className="w-[20%] mx-auto">
                        <ButtonFilled text={"Increase Contribution"} />
                    </div>

                    <h2 className=" mb-2 text-md text-[#121212] font-bold">Project Chat Ledger</h2>

                    <div className="py-4 px-6 shadow-lg">
                        <div className="flex gap-10 mb-6 items-center">
                            <h2 className=" mt-10 mb-6 text-3xl text-black text-center font-bold">Eco-Friendly Packaging</h2>
                            <p className='text-light text-md font-semibold mt-5'>Founder: Andry Soen</p>
                        </div>

                        <div className=" w-[60%] ml-auto mb-6 flex gap-2">
                            {/* message */}
                            <div className=" flex-1 shadow-lg p-2">
                                <div className="flex justify-between">
                                    <p className='text-light text-md font-semibold'>Theresa Web</p>
                                    <p className='text-light text-md'>2 days ago</p>
                                </div>
                                <p>Hey Everyone, This is Theresa and I'm excited to bring everyone onboard for the project!</p>
                            </div>

                            <div className=" flex items-end justify-center ">
                                <img src={profile1} alt="Profile" className="w-10 h-10 rounded-full mr-2" />
                            </div>
                        </div>
                        ...
                        <div className="relative w-full font-gilroy">
                            <input
                                type="text"
                                className="w-full mt-2 border-[.5px] border-[#ADADAD] rounded-lg placeholder:text-[#808080] pl-12 px-4 py-3 md:py-4 outline-none"
                                placeholder="Type Comment here.."
                            />
                            <span
                                className="absolute left-4 top-[48%] cursor-pointer flex items-center gap-3 "
                    ...
                    {/* Key Metrics */}
                    <h2 className=" mt-10 mb-6 text-3xl text-black text-center font-bold">Key Metrics and Insights</h2>
                    <h2 className=" mb-4 text-md text-[#121212] font-bold">Market Research Summary</h2>
                    <p className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                        Our market research for Eco-Friendly Packaging is the following:
                    </p>
                    <ul className='list-disc '>
                        <li className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                            Market Size: $10 billion potential by 2025.
                        </li>
                        <li className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                            Target Audience: Young professionals aged 25-35.
                        </li>
                        <li className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                            Growth Projection: 20% increase in demand over the next 2 years.
                        </li>
                        <li className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                            Key Competitors: 5 major competitors in the industry.
                        </li>
                        <li className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                            Emerging Trends: Increased demand for mobile-friendly solutions.
                        </li>
                        <li className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                            Geographic Focus: North America and Europe are key markets.
                        </li>
                        <li className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                            Market Penetration: 30% untapped market opportunity in this segment.
                        </li>
                    </ul>

                    <h2 className="mt-8 mb-2 text-md text-[#121212] font-bold">Success Metrics</h2>
                    <p className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                        Success Metrics for the project is the following:
                    </p>
                    <ul className='list-disc '>
                        <li className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                            User Adoption Rate: Targeting 10,000 active users in the first 6 months.
                        </li>
                        <li className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                            Revenue Growth: Projecting 15% monthly increase in revenue.
                        </li>
                        <li className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                            Customer Retention: Aiming for 80% retention rate after the first year.
                        </li>
                        <li className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                            Customer Satisfaction: Target of 90% positive feedback from users.
                        </li>
                        <li className='mt-1 text-[#5A5A5A] text-xs sm:text-sm'>
                            Project Milestone Completion: Achieve 5 key milestones in the first year.
                        </li>
                    </ul>
                    ...
                    <div onClick={handleClickPublish} className="w-[20%] mx-auto mt-10">
                        <ButtonFilled text={"Publish"} />
                    </div>

                </div>

            </div>
            <IncreaseContributionModel
                open={openInceraseContribution}
...
export default ProjectDetailsBuild
